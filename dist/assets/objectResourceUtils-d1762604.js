...
return transformWorldFromViewTL + vPositionWorldCameraRelative;
}`)}class ds extends vr{constructor(){super(...arguments),this.transformWorldFromViewTH=$(),this.transformWorldFromViewTL=$(),this.transformViewFromCameraRelativeRS=Tt(),this.transformProjFromView=zt()}}function Qo(t,e){switch(e.normalType){case B.Attribute:case B.Compressed:t.include(Ht,e),t.varyings.add("vNormalWorld","vec3"),t.varyings.add("vNormalView","vec3"),t.vertex.uniforms.add(new Xo("transformNormalGlobalFromModel",r=>r.transformNormalGlobalFromModel),new pe("transformNormalViewFromGlobal",r=>r.transformNormalViewFromGlobal)),t.vertex.code.add(s`void forwardNormal() {
...
}`)}function Es(t){t.uniforms.add(new te("screenSizePerspectiveAlignment",e=>Ms(e.screenSizePerspectiveAlignment||e.screenSizePerspective)))}function Ms(t){return oe(Rs,t.parameters.divisor,t.parameters.offset,t.parameters.minPixelSize,t.paddingPixelsOverride)}const Rs=Ut();function ui(t,e){const r=t.vertex;e.hasVerticalOffset?(Ls(r),e.hasScreenSizePerspective&&(t.include(Os),Es(r),gt(t.vertex,e)),r.code.add(s`
...
}`)}}const Ns=Tr(1,1,0,1),Ds=Tr(1,0,1,1);function Fs(t){t.fragment.uniforms.add(new Z("depthTexture",(e,r)=>r.highlightDepthTexture)),t.fragment.constants.add("occludedHighlightFlag","vec4",Ns).add("unoccludedHighlightFlag","vec4",Ds),t.fragment.code.add(s`void outputHighlight() {
...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=ea(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return gr({colorWrite:xr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-67bb024f.js"),["assets/SSAOBlur.glsl-67bb024f.js","assets/index-ee4f50bd.js","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-3fb771b5.js","assets/vec32-9ab6f0a8.js","assets/DefaultMaterial_COLOR_GAMMA-aeaa672d.js","assets/Version-eb4ced9c.js","assets/quat-a1cb0fe3.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-641fe4da.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-99248a8b.js","assets/InterleavedLayout-0aa3dccc.js","assets/types-1305598a.js","assets/vec4f64-aa64c7e9.js","assets/sphere-9343f5e0.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-86ccd6de.js","assets/Texture-c4e6d56d.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-3eea2780.js","assets/lengthUtils-e9b31b12.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-f71e54a8.js"]));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),t}function Ti(t){return Math.max(10,20*t.computeScreenPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const co=_o(),rl=Object.freeze(Object.defineProperty({__proto__:null,build:tl,getRadius:Ti},Symbol.toStringTag,{value:"Module"}));let ol=class _i extends yr{initializeProgram(e){return new Cr(e.rctx,_i.shader.get().build(),Gt)}initializePipeline(){return gr({colorWrite:xr})}};ol.shader=new Wt(rl,()=>xt(()=>import("./SSAO.glsl-3d8ca409.js"),["assets/SSAO.glsl-3d8ca409.js","assets/index-ee4f50bd.js","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/vec4f64-aa64c7e9.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-3fb771b5.js","assets/vec32-9ab6f0a8.js","assets/DefaultMaterial_COLOR_GAMMA-aeaa672d.js","assets/Version-eb4ced9c.js","assets/quat-a1cb0fe3.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-641fe4da.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-99248a8b.js","assets/InterleavedLayout-0aa3dccc.js","assets/types-1305598a.js","assets/sphere-9343f5e0.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-86ccd6de.js","assets/Texture-c4e6d56d.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-3eea2780.js","assets/lengthUtils-e9b31b12.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-f71e54a8.js"]));const il=2;function Er(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(o,i)=>i.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/il),r.code.add(s`float evaluateAmbientOcclusionInverse() {
