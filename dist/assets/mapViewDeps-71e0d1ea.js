import{fD as Ie,la as ae,en as Ue,gp as $e,K as q,lb as ke,lc as Le,ld as Ne,i7 as He,le as qe,lf as Ge,eq as x,ag as Ve,cT as Pe,E as Ce,eC as We,aA as K,ep as Z,eL as Y,j$ as je,ev as oe,ew as Ke,et as Ye,jr as Xe,jt as Qe,ey as le,hh as Je,jM as Ze,lg as et,lh as tt,s as it,jO as de,li as rt,_ as ue,jP as st,C as nt,ek as at,w as X,P as ot,al as he,cA as lt,lj as dt,U as ce}from"./index-7df220b7.js";import{c as ut}from"./ExpandedCIM-85e23481.js";import{p as ht,s as ct}from"./imageUtils-2740bb3b.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-25b37322.js";import{i as gt}from"./BufferPool-8e31e463.js";import{T as M,E as S,S as $}from"./color-f3f79b89.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-042f00e6.js";import{L as B}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-1931a919.js";import{n as U}from"./programUtils-271702f9.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-7c3d8650.js";import{d as ts,y as is}from"./MagnifierPrograms-7c3d8650.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-6975534b.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as E,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-a9cf086d.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-0ff99485.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as O,T as k}from"./Texture-a748c37c.js";import{r as ss}from"./GraphicsView2D-f37b1db8.js";import{i as as}from"./GraphicContainer-d2517115.js";import{t as be}from"./requestImageUtils-28379f53.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-99572efb.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-fa2983ac.js";import"./GeometryUtils-3cc9f56c.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-6260a1a7.js";import"./floatRGBA-1f39df92.js";import"./AttributeStoreView-86485239.js";import"./TiledDisplayObject-611e0500.js";import"./util-0b4c9e8a.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-4171d0de.js";import"./featureConversionUtils-7b0c7dc1.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-b7d33e6c.js";import"./pbf-3727d532.js";import"./imageutils-5a0e1d6e.js";import"./Matcher-121a4c56.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-1c8573e5.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-30804692.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-98ebb4cc.js";import"./TimeOnly-094f602b.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-06a11b6b.js";import"./projectionSupport-6fc81d1e.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-2b2eea32.js";import"./FeatureContainer-a3f63e4f.js";import"./TileContainer-0ecfcdaa.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
