...
return proj * (view * vec4(pos, 1.0));
    ...
    `)}f([x()],ws.prototype,"instancedDoublePrecision",void 0);const Ot=$();function Cs(t){t.vertex.code.add(s`
    ...
    `)):r.code.add(s`vec3 addVerticalOffset(vec3 worldPos, vec3 localOrigin) { return worldPos; }`)}const Ls=zt();function Ps(t){t.uniforms.add(new te("verticalOffset",(e,r)=>{const{minWorldLength:o,maxWorldLength:i,screenLength:a}=e.verticalOffset,n=Math.tan(.5*r.camera.fovY)/(.5*r.camera.fullViewport[3]),l=r.camera.pixelRatio||1;return oe(Ls,a*l,n,o,i)}))}function $s(t,e){const r=e.output===y.ObjectAndLayerIdColor,o=e.objectAndLayerIdColorInstanced;r&&(t.varyings.add("objectAndLayerIdColorVarying","vec4"),o?t.attributes.add(h.INSTANCEOBJECTANDLAYERIDCOLOR,"vec4"):t.attributes.add(h.OBJECTANDLAYERIDCOLOR,"vec4")),t.vertex.code.add(s`
     void forwardObjectAndLayerIdColor() {
      ...
      void outputObjectAndLayerIdColor() {
        ${r?s`fragColor = objectAndLayerIdColorVarying;`:s``} }`)}function Cr(t){t.code.add(s`const float MAX_RGBA_FLOAT =
255.0 / 256.0 +
255.0 / 256.0 / 256.0 +
...
}`)}function Is(t,e){switch(t.fragment.include(Cr),e.output){case y.Shadow:case y.ShadowHighlight:case y.ShadowExcludeHighlight:t.fragment.code.add(s`float _calculateFragDepth(const in float depth) {
...
return tangentSpace * rawNormal;
  ...
  `)}function Or(t){t.include(Cr),t.code.add(s`float linearDepthFromFloat(float depth, vec2 nearFar) {
...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=ea(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new we("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new wr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-12a8bd99.js"),["assets/SSAOBlur.glsl-12a8bd99.js","assets/index-a06cce50.js","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-68986155.js","assets/vec32-eb4295dd.js","assets/DefaultMaterial_COLOR_GAMMA-e1867e17.js","assets/quat-9bff8376.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-7014a906.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-2174ce4e.js","assets/InterleavedLayout-c5065d51.js","assets/types-1305598a.js","assets/sphere-a0953db6.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-725b25d7.js","assets/Texture-0c92638c.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-9d3fceb6.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-8de1e0c9.js"]));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new we("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
...
return fallOffFunction(vv, vn, 0.1);
}`),e.uniforms.add(new we("nearFar",(r,o)=>o.camera.nearFar),new Z("normalMap",r=>r.normalTexture),new Z("depthMap",r=>r.depthTexture),new we("zScale",(r,o)=>xi(o)),new ee("projScale",r=>r.projScale),new Z("rnm",r=>r.noiseTexture),new we("rnmScale",(r,o)=>Lt(co,o.camera.fullWidth/r.noiseTexture.descriptor.width,o.camera.fullHeight/r.noiseTexture.descriptor.height)),new ee("intensity",r=>r.intensity),new we("screenSize",(r,o)=>Lt(co,o.camera.fullWidth,o.camera.fullHeight))),e.code.add(s`
    void main(void) {
      fillSphere();
  ...
  `),t}function Ti(t){return Math.max(10,20*t.computeScreenPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const co=_o(),rl=Object.freeze(Object.defineProperty({__proto__:null,build:tl,getRadius:Ti},Symbol.toStringTag,{value:"Module"}));let ol=class _i extends yr{initializeProgram(e){return new wr(e.rctx,_i.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};ol.shader=new Wt(rl,()=>xt(()=>import("./SSAO.glsl-226ac9a3.js"),["assets/SSAO.glsl-226ac9a3.js","assets/index-a06cce50.js","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-68986155.js","assets/vec32-eb4295dd.js","assets/DefaultMaterial_COLOR_GAMMA-e1867e17.js","assets/quat-9bff8376.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-7014a906.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-2174ce4e.js","assets/InterleavedLayout-c5065d51.js","assets/types-1305598a.js","assets/sphere-a0953db6.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-725b25d7.js","assets/Texture-0c92638c.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-9d3fceb6.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-8de1e0c9.js"]));const il=2;function Er(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(o,i)=>i.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/il),r.code.add(s`float evaluateAmbientOcclusionInverse() {
...
return outColor;
}`);break;default:Ye(e.pbrMode);case L.COUNT:}}function Nt(t,e){e.hasMultipassTerrain&&(t.fragment.include(Or),t.fragment.uniforms.add(new Z("terrainDepthTexture",(r,o)=>o.multipassTerrain.linearDepthTexture)),t.fragment.uniforms.add(new we("nearFar",(r,o)=>o.camera.nearFar)),t.fragment.uniforms.add(new we("inverseViewport",(r,o)=>o.inverseViewport)),t.fragment.code.add(s`
  ...
  `))}class cl extends J{constructor(e,r,o){super(e,"mat4",V.Draw,(i,a,n,l)=>i.setUniformMatrix4fv(e,r(a,n,l)),o)}}let dl=class extends J{constructor(e,r,o){super(e,"mat4",V.Pass,(i,a,n)=>i.setUniformMatrix4fv(e,r(a,n)),o)}};function Ai(t,e){e.receiveShadows&&(t.fragment.uniforms.add(new dl("shadowMapMatrix",(r,o)=>o.shadowMap.getShadowMapMatrices(r.origin),4)),wi(t))}function yi(t,e){e.receiveShadows&&(t.fragment.uniforms.add(new cl("shadowMapMatrix",(r,o)=>o.shadowMap.getShadowMapMatrices(r.origin),4)),wi(t))}function wi(t){const e=t.fragment;e.include(Cr),e.uniforms.add(new Z("shadowMapTex",(r,o)=>o.shadowMap.depthTexture),new li("numCascades",(r,o)=>o.shadowMap.numCascades),new te("cascadeDistances",(r,o)=>o.shadowMap.cascadeDistances)),e.code.add(s`int chooseCascade(float depth, out mat4 mat) {
