import"./index-02eff6e6.js";import{t as l}from"./NestedMap-b667f687.js";import{r as p}from"./Program-99848a7b.js";class m{constructor(e){this._rctx=e,this._store=new l}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,s){const n=this._store.get(e,t);if(n!=null)return n.ref(),n;const i=new p(this._rctx,e,t,o,s);return i.ref(),this._store.set(e,t,i),i}get test(){}}function u(r){const{options:e,value:t}=r;return typeof e[t]=="number"}function _(r){let e="";for(const t in r){const o=r[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
