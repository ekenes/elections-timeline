import{d5 as Eo,oH as Fa,oZ as Ba,fI as so,d4 as Da,k4 as Va,cg as ja,bu as Io,dW as dt,j2 as Gt,bt as M,j3 as Ha,df as He,gv as ae,bq as Dt,g0 as G,d_ as le,dY as ie,o_ as Ua,i5 as Wa,dg as Je,gA as Ao,aX as Po,du as Vt,gt as Qe,c6 as qa,ex as Ue,o$ as ka,p0 as Ya,dX as ut,bs as wt,gw as Ne,gu as Ft,lI as fe,lJ as K,dc as Lo,p1 as zo,C as g,D as Me,J as No,cd as Za,bI as Ro,bJ as Xa,s as Go,j4 as Ka,_ as ot,fU as jt,bf as te,gr as Fo,fY as We,aU as rt,bZ as Ja,c1 as ht,c3 as Qa,c as ei,fV as ti,k9 as oi,hP as ai,aE as ii,i_ as ri,lK as ni,bp as si,ds as li,aP as ci,p2 as di,iW as Bo,Y as ui,bA as Do,im as Vo,hT as lo,p3 as jo,jf as mt,a8 as hi,dq as co,dr as mi,db as fi,mQ as uo}from"./index-b8632133.js";import{a as pi}from"./devEnvironmentUtils-5c761adb.js";import{t as Et,e as Ht,o as qe}from"./mat3f64-e19cdcb8.js";import{o as ft,r as gi,e as vi}from"./mat4f64-9a8384aa.js";import{c as xi,x as Ho,L as bi,i as Uo,O as Ti,E as yi}from"./BufferView-a598cb7c.js";import{e as Mi,f as wi,l as ho,o as mo}from"./vec3-7d7bc497.js";import{n as Ci,s as fo}from"./vec4-fe1290dd.js";import{n as $i,d as Ie,o as Si,g as _i,t as Oi,h as Ei}from"./DefaultMaterial_COLOR_GAMMA-1989f435.js";import{r as It}from"./resourceUtils-214de2e2.js";import{t as Ii}from"./NestedMap-b667f687.js";import{t as Ai,l as Wo}from"./Indices-3253d062.js";import{t as Pi}from"./requestImageUtils-07ee909b.js";import{t as Le}from"./Attribute-422e3b38.js";import{t as Li,N as pe,s as j,O as qo,e as ge,n as at}from"./basicInterfaces-d9412f98.js";import{s as Re}from"./Util-95651989.js";import{_ as zi,$ as Ye,a0 as ko,h as W,a1 as pt,a2 as ue,a3 as Bt,a4 as Ni,a5 as Ri,m as et,a6 as Gi,a7 as Se,a8 as Fi,p as Bi,a9 as Yo,aa as Di,o as J,q as me,d as Ge,ab as Fe,l as Ke,P as Be,r as Zo,ac as Xo,j as Vi,E as $e,ad as ji,ae as Ut,i as Ct,af as Ko,v as Wt,x as qt,O as kt,B as $t,e as Y,c as Hi,k as Jo,ag as Ui,u as gt,ah as Qo,ai as ea,f as vt,g as ta,aj as Wi,R as qi,ak as ki,al as Yi,am as Zi,z as Xi,an as Ki,C as T,F as we,D as Ji,G as Qi,A as At,ao as er,L as tr,M as or,N as oa}from"./DefaultTechniqueConfiguration-17653ab9.js";import{s as aa,E as ia,U as he}from"./sphere-df5b271a.js";import{v as ar}from"./lineSegment-2e31aeda.js";import"./plane-a919c55a.js";import{e as O}from"./VertexAttribute-ace1421c.js";import{H as ir}from"./InterleavedLayout-3c3c5582.js";import{n as P,t as Yt,b as k,S as rr,u as xt,c as po,o as Pt,r as nr}from"./NormalAttribute.glsl-15306aae.js";import{o as l,r as S,t as ra}from"./interfaces-3cb63efc.js";import{a as Ce}from"./BindType-d21d71dd.js";import{I as sr,L as lr}from"./orientedBoundingBox-1d646f90.js";import{o as cr,r as dr}from"./doublePrecisionUtils-e3c3d0d8.js";import{n as ce}from"./symbolColorUtils-d8defd0d.js";import{T as Zt,d as Xt,_ as ur}from"./renderState-9bda431a.js";function nt(t,e=!1){return t<=Eo?e?new Array(t).fill(0):new Array(t):new Float32Array(t)}function hr(t){t.vertex.code.add(l`
...
float occlusion;`),r&&a.uniforms.add(d===Ce.Pass?new W("texMetallicRoughness",n=>n.textureMetallicRoughness):new pt("texMetallicRoughness",n=>n.textureMetallicRoughness)),s&&a.uniforms.add(d===Ce.Pass?new W("texOcclusion",n=>n.textureOcclusion):new pt("texOcclusion",n=>n.textureOcclusion)),a.uniforms.add(d===Ce.Pass?new ue("mrrFactors",n=>n.mrrFactors):new Bt("mrrFactors",n=>n.mrrFactors)),a.code.add(l`
  ...
  `)}let Er=class{constructor(e=!1,o=!0){this.isVerticalRay=e,this.normalRequired=o}};const lt=qa();function Ir(t,e,o,a,r,i){if(!t.visible)return;const s=Ue(Ur,a,o),u=(n,c,h)=>{i(n,h,c,!1)},d=new Er(!1,e.options.normalRequired);if(t.boundingInfo){Re(t.type===Ye.Mesh);const n=e.tolerance;ua(t.boundingInfo,o,s,n,r,d,u)}else{const n=t.attributes.get(O.POSITION),c=n.indices;Lr(o,s,0,c.length/3,c,n.data,n.stride,r,d,u)}}const Ar=M();function ua(t,e,o,a,r,i,s){if(t==null)return;const u=Br(o,Ar);if(ka(lt,t.bbMin),Ya(lt,t.bbMax),r!=null&&r.applyToAabb(lt),Dr(lt,e,u,a)){const{primitiveIndices:d,position:n}=t,c=d?d.length:n.indices.length/3;if(c>jr){const h=t.getChildren();if(h!==void 0){for(const f of h)ua(f,e,o,a,r,i,s);return}}Pr(e,o,0,c,n.indices,n.data,n.stride,d,r,i,s)}}const Ze=M();function Pr(t,e,o,a,r,i,s,u,d,n,c){const h=t[0],f=t[1],p=t[2],v=e[0],x=e[1],m=e[2],{normalRequired:w}=n;for(let y=o;y<a;++y){const C=u[y],A=3*C,D=s*r[A];let R=i[D],_=i[D+1],N=i[D+2];const I=s*r[A+1];let U=i[I],V=i[I+1],L=i[I+2];const z=s*r[A+2];let q=i[z],E=i[z+1],F=i[z+2];d!=null&&([R,_,N]=d.applyToVertex(R,_,N,y),[U,V,L]=d.applyToVertex(U,V,L,y),[q,E,F]=d.applyToVertex(q,E,F,y));const H=U-R,Q=V-_,oe=L-N,ve=q-R,xe=E-_,re=F-N,be=x*re-xe*m,Te=m*ve-re*v,_e=v*xe-ve*x,ee=H*be+Q*Te+oe*_e;if(Math.abs(ee)<=Hr)continue;const Oe=h-R,_t=f-_,Ot=p-N,Ee=Oe*be+_t*Te+Ot*_e;if(ee>0){if(Ee<0||Ee>ee)continue}else if(Ee>0||Ee<ee)continue;const ao=_t*oe-Q*Ot,io=Ot*H-oe*Oe,ro=Oe*Q-H*_t,it=v*ao+x*io+m*ro;if(ee>0){if(it<0||Ee+it>ee)continue}else if(it>0||Ee+it<ee)continue;const no=(ve*ao+xe*io+re*ro)/ee;no>=0&&c(no,C,w?Gr(H,Q,oe,ve,xe,re,Ze):null)}}function Lr(t,e,o,a,r,i,s,u,d,n){const c=e,h=Wr,f=Math.abs(c[0]),p=Math.abs(c[1]),v=Math.abs(c[2]),x=f>=p?f>=v?0:2:p>=v?1:2,m=x,w=c[m]<0?2:1,y=(x+w)%3,C=(x+(3-w))%3,A=c[y]/c[m],D=c[C]/c[m],R=1/c[m],_=zr,N=Nr,I=Rr,{normalRequired:U}=d;for(let V=o;V<a;++V){const L=3*V,z=s*r[L];G(h[0],i[z+0],i[z+1],i[z+2]);const q=s*r[L+1];G(h[1],i[q+0],i[q+1],i[q+2]);const E=s*r[L+2];G(h[2],i[E+0],i[E+1],i[E+2]),u&&(ut(h[0],u.applyToVertex(h[0][0],h[0][1],h[0][2],V)),ut(h[1],u.applyToVertex(h[1][0],h[1][1],h[1][2],V)),ut(h[2],u.applyToVertex(h[2][0],h[2][1],h[2][2],V))),Ue(_,h[0],t),Ue(N,h[1],t),Ue(I,h[2],t);const F=_[y]-A*_[m],H=_[C]-D*_[m],Q=N[y]-A*N[m],oe=N[C]-D*N[m],ve=I[y]-A*I[m],xe=I[C]-D*I[m],re=ve*oe-xe*Q,be=F*xe-H*ve,Te=Q*H-oe*F;if((re<0||be<0||Te<0)&&(re>0||be>0||Te>0))continue;const _e=re+be+Te;if(_e===0)continue;const ee=re*(R*_[m])+be*(R*N[m])+Te*(R*I[m]);if(ee*Math.sign(_e)<0)continue;const Oe=ee/_e;Oe>=0&&n(Oe,V,U?Fr(h):null)}}const zr=M(),Nr=M(),Rr=M();function Gr(t,e,o,a,r,i,s){return G(bt,t,e,o),G(Tt,a,r,i),Dt(s,bt,Tt),wt(s,s),s}function Fr(t){return Ue(bt,t[1],t[0]),Ue(Tt,t[2],t[0]),Dt(Ze,bt,Tt),wt(Ze,Ze),Ze}const bt=M(),Tt=M();function Br(t,e){return G(e,1/t[0],1/t[1],1/t[2])}function Dr(t,e,o,a){return Vr(t,e,o,a,1/0)}function Vr(t,e,o,a,r){const i=(t[0]-a-e[0])*o[0],s=(t[3]+a-e[0])*o[0];let u=Math.min(i,s),d=Math.max(i,s);const n=(t[1]-a-e[1])*o[1],c=(t[4]+a-e[1])*o[1];if(d=Math.min(d,Math.max(n,c)),d<0||(u=Math.max(u,Math.min(n,c)),u>d))return!1;const h=(t[2]-a-e[2])*o[2],f=(t[5]+a-e[2])*o[2];return d=Math.min(d,Math.max(h,f)),!(d<0)&&(u=Math.max(u,Math.min(h,f)),!(u>d)&&u<r)}const jr=1e3,Hr=1e-7,Ur=M(),Wr=[M(),M(),M()];let qr=class{constructor(e=0){this.componentLocalOriginLength=0,this._totalOffset=0,this._offset=0,this._tmpVertex=M(),this._tmpMbs=ia(),this._tmpObb=new sr,this._resetOffset(e)}_resetOffset(e){this._offset=e,this._totalOffset=e}set offset(e){this._resetOffset(e)}get offset(){return this._offset}set componentOffset(e){this._totalOffset=this._offset+e}set localOrigin(e){this.componentLocalOriginLength=ae(e)}applyToVertex(e,o,a){const r=G(ha,e,o,a),i=G(Zr,e,o,a+this.componentLocalOriginLength),s=this._totalOffset/ae(i);return Ne(this._tmpVertex,r,i,s),this._tmpVertex}applyToAabb(e){const o=this.componentLocalOriginLength,a=e[0],r=e[1],i=e[2]+o,s=e[3],u=e[4],d=e[5]+o,n=Math.abs(a),c=Math.abs(r),h=Math.abs(i),f=Math.abs(s),p=Math.abs(u),v=Math.abs(d),x=.5*(1+Math.sign(a*s))*Math.min(n,f),m=.5*(1+Math.sign(r*u))*Math.min(c,p),w=.5*(1+Math.sign(i*d))*Math.min(h,v),y=Math.max(n,f),C=Math.max(c,p),A=Math.max(h,v),D=Math.sqrt(x*x+m*m+w*w),R=Math.sign(n+a),_=Math.sign(c+r),N=Math.sign(h+i),I=Math.sign(f+s),U=Math.sign(p+u),V=Math.sign(v+d),L=this._totalOffset;if(D<L)return e[0]-=(1-R)*L,e[1]-=(1-_)*L,e[2]-=(1-N)*L,e[3]+=I*L,e[4]+=U*L,e[5]+=V*L,e;const z=L/Math.sqrt(y*y+C*C+A*A),q=L/D,E=q-z,F=-E;return e[0]+=a*(R*F+q),e[1]+=r*(_*F+q),e[2]+=i*(N*F+q),e[3]+=s*(I*E+z),e[4]+=u*(U*E+z),e[5]+=d*(V*E+z),e}applyToMbs(e){const o=ae(he(e)),a=this._totalOffset/o;return Ne(he(this._tmpMbs),he(e),he(e),a),this._tmpMbs[3]=e[3]+e[3]*this._totalOffset/o,this._tmpMbs}applyToObb(e){return lr(e,this._totalOffset,this._totalOffset,Ft.Global,this._tmpObb),this._tmpObb}},kr=class{constructor(e=0){this.offset=e,this.sphere=ia(),this.tmpVertex=M()}applyToVertex(e,o,a){const r=this.objectTransform.transform,i=G(ha,e,o,a),s=Je(i,i,r),u=this.offset/ae(s);Ne(s,s,s,u);const d=this.objectTransform.inverse;return Je(this.tmpVertex,s,d),this.tmpVertex}applyToMinMax(e,o){const a=this.offset/ae(e);Ne(e,e,e,a);const r=this.offset/ae(o);Ne(o,o,o,r)}applyToAabb(e){const o=this.offset/Math.sqrt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]+=e[0]*o,e[1]+=e[1]*o,e[2]+=e[2]*o;const a=this.offset/Math.sqrt(e[3]*e[3]+e[4]*e[4]+e[5]*e[5]);return e[3]+=e[3]*a,e[4]+=e[4]*a,e[5]+=e[5]*a,e}applyToBoundingSphere(e){const o=ae(he(e)),a=this.offset/o;return Ne(he(this.sphere),he(e),he(e),a),this.sphere[3]=e[3]+e[3]*this.offset/o,this.sphere}};const vo=new kr;function Yr(t){return t!=null?(vo.offset=t,vo):null}new qr;const ha=M(),Zr=M();let Xr=class{constructor(e){this.vertexBufferLayout=e}elementCount(e){return e.get(O.POSITION).indices.length}write(e,o,a,r,i,s){Ni(a,r,this.vertexBufferLayout,e,o,i,s)}};fe.LESS;fe.ALWAYS;const Kr={mask:255},Jr={function:{func:fe.ALWAYS,ref:pe.OutlineVisualElementMask,mask:pe.OutlineVisualElementMask},operation:{fail:K.KEEP,zFail:K.KEEP,zPass:K.ZERO}},Qr={function:{func:fe.ALWAYS,ref:pe.OutlineVisualElementMask,mask:pe.OutlineVisualElementMask},operation:{fail:K.KEEP,zFail:K.KEEP,zPass:K.REPLACE}};fe.EQUAL,pe.OutlineVisualElementMask,pe.OutlineVisualElementMask,K.KEEP,K.KEEP,K.KEEP;fe.NOTEQUAL,pe.OutlineVisualElementMask,pe.OutlineVisualElementMask,K.KEEP,K.KEEP,K.KEEP;function xo(t){t.varyings.add("linearDepth","float")}function ma(t){t.vertex.uniforms.add(new et("nearFar",(e,o)=>o.camera.nearFar))}function fa(t){t.vertex.code.add(l`float calculateLinearDepth(vec2 nearFar,float z) {
...
return proj * (view * vec4(pos, 1.0));
}`)}const bo=Ht();function va(t,e){const o=e.hasModelTransformation,a=e.instancedDoublePrecision;o&&(t.vertex.uniforms.add(new Gi("model",i=>i.modelTransformation??ft)),t.vertex.uniforms.add(new Se("normalLocalOriginFromModel",i=>(Lo(bo,i.modelTransformation??ft),bo)))),e.instanced&&a&&(t.attributes.add(O.INSTANCEMODELORIGINHI,"vec3"),t.attributes.add(O.INSTANCEMODELORIGINLO,"vec3"),t.attributes.add(O.INSTANCEMODEL,"mat3"),t.attributes.add(O.INSTANCEMODELNORMAL,"mat3"));const r=t.vertex;a&&(r.include(Fi,e),r.uniforms.add(new Bt("viewOriginHi",(i,s)=>cr(G(ct,s.camera.viewInverseTransposeMatrix[3],s.camera.viewInverseTransposeMatrix[7],s.camera.viewInverseTransposeMatrix[11]),ct)),new Bt("viewOriginLo",(i,s)=>dr(G(ct,s.camera.viewInverseTransposeMatrix[3],s.camera.viewInverseTransposeMatrix[7],s.camera.viewInverseTransposeMatrix[11]),ct)))),r.code.add(l`
    ...
    }`)}const ct=M();function xa(t,e){e.hasSymbolColors?(t.include(hr),t.attributes.add(O.SYMBOLCOLOR,"vec4"),t.varyings.add("colorMixMode","mediump float"),t.vertex.code.add(l`int symbolColorMixMode;
vec4 getSymbolColor() {
...
forwardTextureCoordinates();`),t.include(Be,e),t.include(Ve,e),t.include(Zo,e),a.main.add(l`
          ...
          ${S(r,l`vec4 texColor = texture(tex, ${u?"colorUV":"vuv0"});
                 discardOrAdjustAlpha(texColor);`)}
          outputHighlight();`)}}function on(t,e){const o=t.fragment;e.hasVertexTangents?(t.attributes.add(O.TANGENT,"vec4"),t.varyings.add("vTangent","vec4"),e.doubleSidedMode===Z.WindingOrder?o.code.add(l`mat3 computeTangentSpace(vec3 normal) {
...
}`),e.textureCoordinateType!==$e.None&&(t.include(ko,e),o.uniforms.add(e.bindType===Ce.Pass?new W("normalTexture",a=>a.textureNormal):new pt("normalTexture",a=>a.textureNormal)),e.hasNormalTextureTransform&&(o.uniforms.add(new et("scale",a=>a.scale??zo)),o.uniforms.add(new Se("normalTextureTransformMatrix",a=>a.normalTextureTransformMatrix??qe))),o.code.add(l`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`)}function _a(t){const e=3.141592653589793,o=.3183098861837907;t.vertex.constants.add("PI","float",e),t.fragment.constants.add("PI","float",e),t.fragment.constants.add("LIGHT_NORMALIZATION","float",o),t.fragment.constants.add("INV_PI","float",o),t.fragment.constants.add("HALF_PI","float",1.570796326794897),t.fragment.constants.add("TWO_PI","float",6.28318530717958)}function Qt(t,e){const o=t.fragment.code;t.include(_a),e.pbrMode!==$.Normal&&e.pbrMode!==$.Schematic&&e.pbrMode!==$.Simplified&&e.pbrMode!==$.TerrainWithWater||(o.add(l`float normalDistribution(float NdotH, float roughness)
{
...
return outColor;
}`))}const wn=.4;function eo(t){t.constants.add("ambientBoostFactor","float",wn)}function to(t){t.uniforms.add(new J("lightingGlobalFactor",(e,o)=>o.lighting.globalFactor))}function Oa(t,e){const o=t.fragment;switch(t.include(Jt,e),e.pbrMode!==$.Disabled&&t.include(Qt,e),t.include(Tn,e),t.include(_a),o.code.add(l`
...
}`)):t.vertex.code.add(l`void forwardColorUV(){}`)}function _n(t,e){e.hasNormalTextureTransform&&e.textureCoordinateType!==$e.None?(t.varyings.add("normalUV","vec2"),t.vertex.uniforms.add(new Se("normalTextureTransformMatrix",o=>o.normalTextureTransformMatrix??qe)).code.add(l`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):t.vertex.code.add(l`void forwardNormalUV(){}`)}function On(t,e){e.hasEmissionTextureTransform&&e.textureCoordinateType!==$e.None?(t.varyings.add("emissiveUV","vec2"),t.vertex.uniforms.add(new Se("emissiveTextureTransformMatrix",o=>o.emissiveTextureTransformMatrix??qe)).code.add(l`void forwardEmissiveUV(){
...
metallicRoughnessUV = (metallicRoughnessTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
  ...
  `)}function An(t){const e=new Ct,{vertex:o,fragment:a,varyings:r}=e,{output:i,normalType:s,offsetBackfaces:u,instancedColor:d,spherical:n,receiveShadows:c,snowCover:h,pbrMode:f}=t,{multipassEnabled:p,textureAlphaPremultiplied:v,instancedDoublePrecision:x,hasVertexColors:m,hasVertexTangents:w}=t,{hasColorTexture:y,hasNormalTexture:C,hasNormalTextureTransform:A,hasColorTextureTransform:D}=t;if(Ge(o,t),e.include(Qo),r.add("vpos","vec3"),e.include(Ke,t),e.include(va,t),e.include(ea,t),e.include(Sn,t),!xt(i))return e.include(ya,t),e;e.include(_n,t),e.include(On,t),e.include(En,t),e.include(In,t),vt(o,t),e.include(Yt,t),e.include(De,t);const R=s===k.Attribute||s===k.Compressed;return R&&u&&e.include(ga),e.include(on,t),e.include(Xo,t),d&&e.attributes.add(O.INSTANCECOLOR,"vec4"),r.add("vPositionLocal","vec3"),e.include(Fe,t),e.include(pa,t),e.include(xa,t),e.include(ba,t),o.uniforms.add(new Y("externalColor",_=>_.externalColor)),r.add("vcolorExt","vec4"),p&&r.add("depth","float"),o.main.add(l`
      ...
      forwardEmissiveUV();
      forwardOcclusionUV();
      forwardMetallicRoughnessUV();`),e.include(Oa,t),e.include(Jt,t),e.include(Ve,t),e.include(x?Ea:Ia,t),e.include(ta,t),e.include(Be,t),e.include(La,t),vt(a,t),a.uniforms.add(o.uniforms.get("localOrigin"),new ue("ambient",_=>_.ambient),new ue("diffuse",_=>_.diffuse),new J("opacity",_=>_.opacity),new J("layerOpacity",_=>_.layerOpacity)),y&&a.uniforms.add(new W("tex",_=>_.texture)),e.include(da,t),e.include(Qt,t),a.include(Pa),e.include($r,t),eo(a),to(a),tt(a),a.main.add(l`
      discardBySlice(vpos);
